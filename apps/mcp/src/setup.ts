...
console.log('  3. Memory tools (store_memory, search_memory, list_memories) and policy')
console.log('     tools (list_policies, create_policy, update_policy, delete_policy,')
console.log('     check_policy) are now available')
console.log('')
