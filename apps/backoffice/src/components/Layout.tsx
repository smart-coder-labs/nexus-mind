    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-5 pt-6 pb-5">
        ...
        <div className="mt-2 flex items-center gap-1.5">
          <Shield className="w-2.5 h-2.5 text-accent-blue flex-shrink-0" />
          <span className="text-[11px] text-accent-blue font-medium tracking-wide uppercase">
            Backoffice
          </span>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-bg-secondary flex">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="lg:hidden flex items-center gap-3 px-4 py-3 border-b border-border-primary bg-bg-primary">
          ...
          <div className="flex items-center gap-2">
            <Zap className="w-4 h-4 text-accent-blue flex-shrink-0" />
            <p className="text-sm font-medium text-text-primary">NexusMind Backoffice</p>
          </div>
        </header>
