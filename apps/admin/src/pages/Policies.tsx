  ...
  return (
    <div className="px-6 pt-6 pb-4">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-[21px] font-semibold text-text-primary tracking-[0.231px]">Policies</h1>
        ...
        <button
          ...
          className="flex items-center gap-2 bg-accent-blue hover:bg-accent-blue-hover text-white text-sm font-semibold px-4 py-2 rounded-full transition-colors"
        >
      ...
      {isLoading ? (
        ...
        <div className="bg-[#272729] rounded-[18px] border border-border-primary p-12 flex flex-col items-center gap-3 text-center">
          ...
          <p className="text-sm font-semibold text-text-secondary">No policies yet</p>
          ...
          {policies.map(policy => (
            ...
            >
              ...
              <div className="flex items-center justify-between gap-2">
                <span className="font-semibold text-text-primary text-sm truncate">{policy.name}</span>
                {policy.enabled ? (
