...
export function Header() {
  ...
  return (
    <header
      className="sticky top-0 z-40 flex items-center gap-4 px-6 py-3 border-b"
      style={{
        ...
        {showResults && (
          ...
          >
                ...
                {results.subtopics.slice(0, 5).map(s => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="text-sm truncate" style={{ color: 'var(--text-primary)' }}>{s.label}</div>
            ...
            {results && results.resources.length > 0 && (
              <div>
                <div className="px-3 py-1.5 text-xs font-medium uppercase tracking-wider"
                  style={{ color: 'var(--text-muted)', borderTop: '1px solid var(--border)', borderBottom: '1px solid var(--border)' }}>
                  Resources
                </div>
