...
const MonitorIcon = Monitor as React.ElementType;
...
export interface ThemeToggleProps {
    ...
    /** Solo muestra el ícono sol/luna como botón pequeño, sin el panel completo. */
    ...
    if (variant === 'inline') {
        return (
            <button
                ...
                className={cn(
                    'inline-flex items-center justify-center rounded-lg p-1.5 text-text-secondary transition-colors hover:bg-surface-secondary hover:text-text-primary',
                    className
                )}
