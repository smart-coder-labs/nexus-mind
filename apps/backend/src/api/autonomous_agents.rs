...
pub fn managed_templates() -> Vec<AutonomousAgentTemplate> {
    vec![
        ...
        AutonomousAgentTemplate {
            ...
            config_schema: serde_json::json!({"outputs":{"type":"array","items":["nexusmind","slack","github_issue"]},"repository":{"type":"owner/repo","required":true},"github_auth":{"const":"server_gh_cli"},"server_integrations":{"github":"gh_cli","slack":"claude_mcp:slack"},"sast":{"ruleset":{"enum":["auto","p/ci","p/owasp-top-ten"],"default":"auto","description":"Semgrep ruleset; a bundled name or a checkout-relative .yml path"}},"sca":{"enabled":{"type":"boolean","default":true,"description":"Run the dependency audit (osv-scanner over lockfiles)"}},"custom_instructions":{"type":"string","description":"Optional triage guidance; cannot expand scope"}}),
            workflow: vec![
                "checkout".into(),
                "sast_scan".into(),
                "sca_audit".into(),
