    ...
    vec![
        ...
        AutonomousAgentTemplate {
            ...
            config_schema: serde_json::json!({
                ...
                "images":{"type":"object","description":"Post imagery","properties":{"enabled":{"type":"boolean","default":false},"per_post":{"type":"number","default":1,"description":"Images generated per post (1-4)"},"provider":{"enum":["higgsfield","cloudflare"],"default":"higgsfield","description":"Where images are generated. Chosen explicitly, never chained: two providers render the same design system differently, so mixing them would make the feed's look depend on which one answered."},"model":{"type":"string","default":"gpt_image_2","description":"Higgsfield job type (ignored for cloudflare, which uses FLUX.1 schnell). Credit cost per image varies ~6.5x between them."}}},
